...
const AssistantManager = lazyWithRetry(() => import('./pages/AssistantManager'));
      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          >
            ...
            <Route path="/assistant" element={<FeatureGuard feature="assistant"><AssistantManager /></FeatureGuard>} />
