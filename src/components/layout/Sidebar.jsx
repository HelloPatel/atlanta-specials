...
export const NAV_ITEMS = [
  ...
  { to: '/catering', icon: UtensilsCrossed, label: 'Catering', feature: 'catering' },
  { to: '/budget', icon: Wallet, label: 'Budget', feature: 'budget' },
  { to: '/assistant', icon: Sparkles, label: 'AI Assistant', feature: 'assistant' },
